...
public class SpawnerScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            spawnRate = Random.Range(0.5f, 3.0f);
            ...
            {
                whereToSpawn = new Vector2((transform.position.x + randX), (transform.position.y + 20.0f)); //change value depending on camera size
            }
